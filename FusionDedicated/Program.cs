...
public static class Program
{
    ...
    public static async Task<int> Main(string[] args)
    {
        ...
        var pluginWorld = new PluginWorld
        {
        ...
        {
            server.Log("WARN", "No Steam lobby yet, so the server is not in the browser. " +
    ...
    private static void Banner(ServerConfig config)
    {
        ...
        Console.WriteLine();
        Console.WriteLine("  ╔══════════════════════════════════════════════╗");
        Console.WriteLine("  ║       FUSION DEDICATED HEADLESS SERVER       ║");
        Console.WriteLine("  ╚══════════════════════════════════════════════╝");
        Console.ResetColor();
        Console.WriteLine();
